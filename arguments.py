...
def get_args():
    ...
    # The MI arguments
    parser.add_argument('--hidden-dim', type=int, default=128, help='the hidden layer dimension')
    parser.add_argument('--mi-control-lr', type=float, default=0.001, help='the learning rate of the Mutual Control Estimator')
